        ...
        <View style={styles.contentContainer}>
          ...
          <View style={styles.controls}>
            <TouchableOpacity 
              ...
              style={[styles.controlButton, pageNumber <= 1 && styles.disabledButton]}
            >
            ...
            <TouchableOpacity 
              onPress={() => setPageNumber(p => Math.min(numPages || 1, p + 1))} 
              disabled={!numPages || pageNumber >= numPages}
              style={[styles.controlButton, (!numPages || pageNumber >= numPages) && styles.disabledButton]}
            >
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingHorizontal: 16, backgroundColor: '#1a1f29', zIndex: 10,
  },
  title: { color: '#fff', fontSize: 18, fontWeight: '600' },
  closeButton: { padding: 8, cursor: 'pointer' } as any,
  contentContainer: {
    flex: 1, justifyContent: 'center', alignItems: 'center',
    width: '100%', paddingTop: 60, paddingBottom: 80, overflow: 'hidden',
  },
  controls: {
    position: 'absolute', bottom: 30,
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: '#242b38', paddingVertical: 10, paddingHorizontal: 20,
  ...
  pageInfo: {
    color: '#fff', fontSize: 16, fontWeight: '600', minWidth: 50, textAlign: 'center',
  },
});